...
parser.add_argument("--checkpoint", default='facades_train', help="directory with checkpoint to resume training from or use for testing")
...
#%%    export the meta
    if a.mode == "export":
        ...
        with tf.variable_scope("generator"):
            batch_output = tools.deprocess(create_generator(tools.preprocess(batch_input), 3))
